...
parser.add_argument("dir1", type=str, default='../agent', nargs="?", help="Directory to agent 1 to be tested.")
parser.add_argument("dir2", type=str, default='test_agents/SomeAgent', nargs="?",
